...
def get_input_args():
    ...
    # Add arguments for directory, architecture, and dogfile
    parser.add_argument('--dir', type=str, default='pet_images/', help='Directory with pet images')
